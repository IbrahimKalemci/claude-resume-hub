...
function recentSessions(limit) {
  ...
  for (const c of cand) {
    ...
    out.push({
      ...
      preview: firstUserMessage(lines).slice(0, 90), project: path.basename(cwd) || cwd,
    });
  }
  return out;
}
...
module.exports = {
  ...
  newestTranscript, sessionIdleMs, sessionMtimeMs, limitFromTranscript, recentSessions,
};
